...
public:
	...
	virtual Vector3 ScriptGetPlayerOrNPCViewVector() = 0; // 260
	virtual Vector3 ScriptGetPlayerOrNPCViewForward() = 0; // 261
	virtual Vector3 ScriptGetPlayerOrNPCViewUp() = 0; // 262
	virtual Vector3 ScriptGetPlayerOrNPCViewRight() = 0; // 263
	virtual void PrintInventory() = 0; // 264
};

static_assert(sizeof(C_BaseCombatCharacter) == 0x30);
