...
class CPlayer : public CBaseCombatCharacter
{
  ...
  public:
    ...
    char _unk_0x209c[316];                                   // 0x209c ( Size: 316 )
...
static_assert(offsetof(CPlayer, m_selectedOffhand) == 0x1354);
...
static_assert(offsetof(CPlayer, m_pCurrentCommand) == 0x21D8);
